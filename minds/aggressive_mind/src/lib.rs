...
use blob_mind_utils::{
    attack_payload, available_slots, best_energy_slot, choose_slot, current_food,
    legal_action_or_wait, preferred_effort, split_allocation,
};
#[cfg(target_arch = "wasm32")]
use extism_pdk::*;
